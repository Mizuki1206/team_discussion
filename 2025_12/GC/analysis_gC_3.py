...
# --- 設定 ---
LOG_FILE = "/Users/mizuki/team_discussion/2025_12/meeting_log/meeting_log_gC_3.txt"
OUTPUT_CSV = "/Users/mizuki/team_discussion/2025_12/analysis_csv/analysis_csv_gC_3.csv"
NUM_SEGMENTS = 20
...
IGNORE_PHRASES = [
    ...
    "わかる", "それな", "ですね", "オッケー", "OK", "大丈夫", "いいと思う", "いいね",
    
    # フィラー（言い淀み）・口語
    "えー", "えっと", "え～", "あの", "あのー", "その", "んー", "うーん", "うー",
    "まあ", "なんか", "なんて", "っす", "ていうか", "っていうか", "ていう", "という",
    "なんかこう", "みたいな", "感じ", "やつ", "ほう", "風に", "的な",
    
    # 意味の薄い言葉・副詞
    "ちょっと", "一応", "多分", "結構", "かなり", "すごい", "すごく", 
    "やっぱり", "やっぱ", "かも", "しれない", "だいたい", "色々", "一番", "割と", "普通に",
    
    # 接続詞的な口語
    "でも", "だけど", "だから", "けど", "じゃあ", "では", "あと",
    "それこそ", "なんで", "どう", "こう", "それで", "そこで", "それなら",
