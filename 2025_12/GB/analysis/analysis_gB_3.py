...
# --- 設定 ---
LOG_FILE = "/Users/mizuki/team_discussion/2025_12/meeting_log/meeting_log_gB_3.txt"
OUTPUT_CSV = "/Users/mizuki/team_discussion/2025_12/analysis_csv/analysis_csv_gB_3.csv"
NUM_SEGMENTS = 20

# ノイズ除去リスト（ファイル分析に基づく）
IGNORE_PHRASES = [
    # 頻出するフィラー・口語
    "なんか", "やっぱ", "ていうか", "っていうか", "あのー", "その", "えー", "えっと", 
    "まあ", "なんかこう", "といった", "ほう", "やつ", "みたいな", "感じ", "結構",
    ...
    "チャット", "残り時間", "Google", "ドキュメント", "書記", "リンク", "貼って"
]
