...
# --- 設定 ---
LOG_FILE = "/Users/mizuki/team_discussion/2025_12/meeting_log/meeting_log_gB_4.txt"
OUTPUT_CSV = "/Users/mizuki/team_discussion/2025_12/analysis_csv/analysis_csv_gB_4.csv"
NUM_SEGMENTS = 20
...
IGNORE_PHRASES = [
    ...
    "オッケー", "OK", "大丈夫", "了解", "わかった", "いいと思う", "それで",
    
    # 口語・フィラー
    "なんか", "やっぱ", "ていうか", "っていうか", "あの", "あのー", "その", "えー", 
    "えっと", "まあ", "なんていうか", "っすね", "かも", "しれない", "一応",
